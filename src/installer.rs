...
pub const HOOK_VERSION_TAG: &str = concat!("# zellaude v", env!("CARGO_PKG_VERSION"));

/// Insert the version tag immediately after the shebang line.
pub fn tag_script(original: &str) -> String {
...
fn hook_script_content() -> String {
    tag_script(include_str!("../scripts/zellaude-hook.sh"))
}

fn notify_script_content() -> String {
    tag_script(include_str!("../scripts/zellaude-notify.sh"))
}
